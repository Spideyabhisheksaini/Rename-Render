...
FORCE_SUB = os.environ.get("FORCE_SUB", "Movies_Telegram_Files") 
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Tonystarkbotz:dgRUcv8OktóDazpd@cluster0.pg5q3xr.mongodb.net/?retryWrites=true&w=majority")
